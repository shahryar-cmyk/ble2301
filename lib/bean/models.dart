...
class MyPersonalInfo{
  ...
  ///step length
  int stepLength = 70;
  MyPersonalInfo({required this.sex,
    required this.age,
...
class MySedentaryReminder{
  ...
  MySedentaryReminder({required this.startHour,
...
class MyDeviceInfo{
  ...
  bool Hand_up_light_screen_switch = false;//抬手亮屏开关 Raise the hand and turn on the screen
  ...
  MyDeviceInfo({required this.DistanceUnit,
...
class WeatherData{
  ...
  int weatherId = 0;
  WeatherData({required this.tempNow,
...
class MyAutomaticHRMonitoring{
  ...
  int type = 1;
  MyAutomaticHRMonitoring({required this.open,
